...
public:
  ...
  /**
	 * transformedObservation Transform each observation marker from the vehicle's coordinates
   *   to the map's coordinates, in respect to our particle.
	 * @param particle Current particle
	 * @param observation Landmark observations
	 */
	void transformedObservation(Particle particle, LandmarkObs& observation);
